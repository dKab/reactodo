    ...
    return(
        <div className="category">
            ...
            <div className="fr">
                ...
                <span className="category__add-btn" onClick={() => getName(props.onPlusClick, props.category)}><Plus /></span>
...
function getName(callback, cat) {
    let name = prompt('Enter category name: ');
    if (!name) {
        return;
    }
    return callback(name, cat.parentId);
}